...
<div class="container">
	<div style="margin: 0px auto; padding-top: 30px;  margin-bottom:100px;">
		<div class="page-header">
		    <h1><span class="glyphicon glyphicon-comment"></span>&nbsp;<b>Event</b></h1>      
		</div>
							...
							<tr height="40">
								<td align="left" width="100">
									<button type="button" class="btn btn-default btn-sm"
										onclick="javascript:location.href='<%=cp%>/user/bbs/list';">새로고침</button>
								</td>
								<td align="center">
								...
								<c:if test="${not empty sessionScope.member }">
									<button type="button" class="btn btn-default btn-sm"
										onclick="javascript:location.href='<%=cp%>/user/bbs/created';">
										게시물 작성
									</button>
								</c:if>
								</td>
