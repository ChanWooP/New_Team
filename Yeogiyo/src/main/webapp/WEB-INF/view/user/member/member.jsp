...
<div style="margin: 0px auto; padding-top: 80px; width: 700px;">
	<div class="mainform">
		<span style="font-weight: bold; font-size: 30px;">
		${mode=="join"?"회원 가입":"회원 정보 수정" }
		</span>
	</div>
	...
	<tr>
		<td width="120" valign="top" style="text-align: right; padding-top: 5px;">
		 ...
		 <td width="120" valign="top" style="text-align: right; padding-top: 5px;">
		     ...
		     <td style="padding: 0 0 15px 15px;">
		       <p style="margin-bottom: 10px;">
		           <input type="text" name="userName" value="${dto.userName}" style="width: 95%;"
                         ${mode=="update" ? "readonly='readonly' ":""}
                         maxlength="15" class="boxTF" placeholder="이름">
		       </p>
		    </td>
	</tr>
	<tr>
		 ...
		 <tr>
		  ...
		  <c:if test="${mode=='member'}">
			  ...
			  <table style="width: 100%; margin: 0px auto; border-spacing: 0px;">
			     <tr height="45"> 
			      <td align="center" >
			        <button type="button" name="sendButton" class="memberbtn" onclick="memberOk();">${mode=="join"?"회원가입":"정보수정"}</button>
			        <button type="reset" class="memberbtn">다시입력</button>
			        <button type="button" class="memberbtn" onclick="javascript:location.href='<%=cp%>/';">${mode=="join"?"가입취소":"수정취소"}</button>
			      </td>
			    </tr>
			    <tr height="30">
