	...
	<c:forEach var="vo" items="${listReply}">
	    ...
	    <tr>
	        <td style='padding:7px 5px;'>
	            ...
	            <span id="answerCount${vo.replyNum}">${vo.answerCount}</span></button>
	        </td>
	        <td style='padding:7px 5px;' align='right'>
                <button type='button' class='btn btn-default btnSendReplyLike' data-replyNum='${vo.replyNum}' data-replyLike='1'>
                <span class="glyphicon glyphicon-thumbs-up"></span>&nbsp;<span>${vo.likeCount}</span></button>
	            ...
	            <c:if test="${not empty sessionScope.member}">
		            <div style='clear: both; padding: 10px 10px;'>
		             ...
		             <div style='padding: 0px 13px 10px 10px; text-align: right;'>
		                <button type='button' class='btn btn-default btnSendReplyAnswer' data-replyNum='${vo.replyNum}'>답글 등록</button>
		            </div>
	        	</c:if>
	        </td>
	    </tr>
