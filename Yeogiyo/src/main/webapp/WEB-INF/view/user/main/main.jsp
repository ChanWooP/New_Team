	 ...
	 <div id="mainsearch" style="margin-top:30px; height:500px;">
    	<div style="width:500px; margin:60px; margin-bottom:10px; min-height:330px; border:1px solid yellow; background-color:white;">
    		...
    		<div style="margin:20px;">
			    ...
			    <input style="width:430px; height:40px; border: 1px solid #ccc; border-radius: 4px;"
			    	type="text" placeholder="가고싶은 여행지를 입력해주세요" name="place">
			    </div>
			</div>
			<div style="margin:20px;">    
			    <div>
			    <label><b>체크인 날짜</b></label>
			    ...
			    <div style="margin-top:10px;">
			    <select style="width:200px; height:40px; border: 1px solid #ccc; border-radius: 4px;"
			    	name="pnum">
			    ...
			    <button style="width:200px; height:40px; background-color: #4CAF50; border: none; border-radius: 4px;">
			    <b>검색</b>
			    </button>
			    </div>
			    </div>
    	...
    	<div style="width:500px; margin-left:60px; min-height:60px; border:1px solid yellow; background-color:white;">
    	<div style="margin:5px; margin-left:20px;"><b>인기 여행지 : </b></div>
    	</div>
    </div>
</div> 
