...
<body>
	<div class="container">
		<div class="left-nav">
			<ul>
				...
				<li class="left-nav-activated"><a href="<%=cp%>/owner/hotelRegister/register6"><i class="fas fa-check" style="color: #3B1E1E"></i>등록 완료</a></li>
			</ul>
		</div>
	...
	<script>
		function back(){
			window.location.href="<%=cp%>/owner/hotelRegister/register5";
		}
	</script>
</body>
</html>